# Autoresearch Program — .NET AI Toolkit Plugin Skills
...
- `plugins/dotnet/skills/*/SKILL.md`
- `plugins/dotnet/skills/*/references/*.md`

## Read-Only (NEVER mutate)

- `lab/**` (eval infrastructure, this file, scripts)
- `plugins/dotnet/agents/**`
- `plugins/dotnet/hooks/**`
- `plugins/dotnet/.claude-plugin/**`
- `CLAUDE.md`
- `CHANGELOG.md`
- `README.md`
