...
Usage:
    python3 lab/autoresearch/scripts/score-skill.py plugins/dotnet/skills/review/SKILL.md
    python3 lab/autoresearch/scripts/score-skill.py plugins/dotnet/skills/review/SKILL.md lab/eval/evals/review.json
