...
Usage:
    python -m lab.eval.scorer plugins/dotnet/skills/plan/SKILL.md
    python -m lab.eval.scorer plugins/dotnet/skills/plan/SKILL.md --eval lab/eval/evals/plan.json
...
PLUGIN_ROOT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "plugins", "dotnet")
