...
PLUGIN_SKILLS_DIR = os.path.join(
    os.path.dirname(__file__), "..", "..", "..", "plugins", "dotnet", "skills"
)
PLUGIN_AGENTS_DIR = os.path.join(
    os.path.dirname(__file__), "..", "..", "..", "plugins", "dotnet", "agents"
)
...
class TestScoreAgent:
    def test_scores_real_agent(self):
        ...
        reviewer_path = os.path.join(PLUGIN_AGENTS_DIR, "dotnet-reviewer.md")
